...
namespace project.core.Migrations
{
    ...
    [Migration("20240119221956_SuperAdminSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("project.core.Models.movieModel", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("project.core.Models.roomModel", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("project.core.Models.seanceModel", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("project.core.Models.seanceModel", b =>
                {
                    b.HasOne("project.core.Models.movieModel", "movie")
                        .WithMany()
                        .HasForeignKey("movieid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("project.core.Models.roomModel", "room")
                        .WithMany()
